import { SET_CURRENT_MESSAGES, GET_CURRENT_MESSAGES, SET_MESSAGES_FOR_EVERYONE, GET_MESSAGES_FOR_EVERYONE, SET_MESSAGES_TYPE,UPDATE_MESSAGE } from '../actions/types';
